...
public class AlumnoController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Alumno> getAutorId(@PathVariable("id") Long id){
		try {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Alumno> delAutor(@PathVariable("id") Long id){
		try {
	...
	@PutMapping("/{id}")
	public ResponseEntity<?> updateAutor(@PathVariable("id") Long id, @Valid @RequestBody Alumno cat){
